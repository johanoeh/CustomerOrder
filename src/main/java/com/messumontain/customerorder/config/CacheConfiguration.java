package com.messumontain.customerorder.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.messumontain.customerorder.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.messumontain.customerorder.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.messumontain.customerorder.domain.CustomerOrder.class.getName() + ".orderItems");
